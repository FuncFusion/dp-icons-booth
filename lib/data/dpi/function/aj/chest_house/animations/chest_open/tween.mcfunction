...
execute at @s run function dpi:aj/chest_house/animations/chest_open/zzz/apply_frame {frame: 0}
$execute at @s run function dpi:aj/chest_house/animations/chest_open/zzz/apply_frame {frame: $(to_frame)}
