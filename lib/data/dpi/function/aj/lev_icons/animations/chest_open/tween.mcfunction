...
tag @s add dpi.aj.lev_icons.animation.chest_open.playing
...
execute at @s run function dpi:aj/lev_icons/animations/chest_open/zzz/apply_frame {frame: 0}
$execute at @s run function dpi:aj/lev_icons/animations/chest_open/zzz/apply_frame {frame: $(to_frame)}
