...
$scoreboard players set @s aj.mcf_tick_levitate.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function dpi:anijava/chest_house/animations/mcf_tick_levitate/zzz/apply_frame {frame: 0}
$execute at @s run function dpi:anijava/chest_house/animations/mcf_tick_levitate/zzz/apply_frame {frame: $(to_frame)}
