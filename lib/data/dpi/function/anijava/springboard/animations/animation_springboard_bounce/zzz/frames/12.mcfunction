...
$data merge entity $(top) {transformation: [-1.6667f,0f,0f,0f,0f,1.6667f,0f,0.5158f,0f,0f,-1.6667f,0f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
