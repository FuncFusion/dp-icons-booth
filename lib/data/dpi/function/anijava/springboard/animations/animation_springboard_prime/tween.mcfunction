...
$scoreboard players set @s aj.animation_springboard_prime.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function dpi:anijava/springboard/animations/animation_springboard_prime/zzz/apply_frame {frame: 0}
$execute at @s run function dpi:anijava/springboard/animations/animation_springboard_prime/zzz/apply_frame {frame: $(to_frame)}
