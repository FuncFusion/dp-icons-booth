...
tag @s add dpi_aj.chest_house.animation.chest_open.playing
...
execute at @s run function dpi_aj:chest_house/animations/chest_open/zzz/apply_frame {frame: 0}
$execute at @s run function dpi_aj:chest_house/animations/chest_open/zzz/apply_frame {frame: $(to_frame)}
